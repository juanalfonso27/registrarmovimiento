...
class AgroGPSApp {
  ...
  init() {
    ...
    // Ensure there's at least one product line in the form
    const container = document.getElementById('products-container')
    if (container && container.querySelectorAll('.product-line').length === 0) {
      this.addProductLine()
    }
  ...
  initMap() {
    ...
    // Layer control to allow switching between satellite and street
    const baseMaps = {
